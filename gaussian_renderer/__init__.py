...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, return_smpl_rot=False, transforms=None, translation=None, depth_threshold = None):
    """
    Render the scene. 
    ...
    if not pc.motion_offset_flag:
        ...
        if transforms is None:
            ...
            # transform points smpl_param真实 big假
